...
def ganaMoneda(moneda:str):
    ...
    if moneda == 'ccl-mep':
        ccl   += round( vendoA - (comproB * (pr.precioOF('MERV - XMEV - ' + e[2].upper() + u[1] + ' - ' + o +'') / 100) )     ,3)
        mep   += round( vendoB - (comproA * (pr.precioOF('MERV - XMEV - ' + e[0].upper() + u[3] + ' - ' + o +'') / 100) )     ,3)

    elif moneda == 'mep-ccl':
        mep   += round( vendoA - (comproB * (pr.precioOF('MERV - XMEV - ' + e[2].upper() + u[1] + ' - ' + o +'') / 100) )     ,3)
        ccl   += round( vendoB - (comproA * (pr.precioOF('MERV - XMEV - ' + e[0].upper() + u[3] + ' - ' + o +'') / 100) )     ,3)

    elif moneda == 'ccl-pes':
        ccl   += round( vendoA - (comproB * (pr.precioOF('MERV - XMEV - ' + e[2].upper() + u[1] + ' - ' + o +'') / 100) )     ,3)
        pesos += round( vendoB - (comproA * (pr.precioOF('MERV - XMEV - ' + e[0].upper() + u[3] + ' - ' + o +'') / 100) )     ,3)
...
while True:
    if time.strftime("%H:%M:%S") < '11:00:00':
        ...
        continue
    if limite < 200 or time.strftime("%H:%M:%S") > '22:59:50':
        ...
        for o in plazo:
            for i,u in moneda.items():
                ...
                while True: 
                    if limite < 200:  break
                    if comproA > e[1]:
                        if e[0] == 'al30' or e[2] == 'al30': limite -= int( comproA - e[1])
